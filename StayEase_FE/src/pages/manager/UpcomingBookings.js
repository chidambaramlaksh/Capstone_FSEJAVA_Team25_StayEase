...
export default function UpcomingBookings() {
    ...
    const filtered = useMemo(() => bookings.filter((booking) => (booking.guestName + booking.guestEmail + booking.hotelName + booking.roomNumber)
        .toLowerCase()
        .includes(query.toLowerCase()) &&
        (status === "all" || booking.status === status)), [bookings, query, status]);
    return (_jsxs("section", { className: "manager-page", children: [_jsx("div", { className: "manager-page__heading", children: _jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "GUEST STAYS" }), _jsx("h1", { children: "Upcoming bookings" }), _jsx("p", { children: "Reservations arriving soon across your assigned hotels." })] }) }), _jsxs("div", { className: "manager-toolbar", children: [_jsx("input", { "aria-label": "Search bookings", placeholder: "Search guest, hotel, email, or room\u2026", value: query, onChange: (event) => setQuery(event.target.value) }), _jsxs("select", { "aria-label": "Filter bookings by status", value: status, onChange: (event) => setStatus(event.target.value), children: [_jsx("option", { value: "all", children: "All booking statuses" }), _jsx("option", { value: "BOOKED", children: "Confirmed" })] })] }), error ? (_jsx("p", { className: "manager-empty", role: "alert", children: error })) : loading ? (_jsx("p", { className: "manager-empty", children: "Loading bookings\u2026" })) : (_jsxs("div", { className: "booking-table-wrap", children: [_jsxs("table", { className: "booking-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Guest" }), _jsx("th", { children: "Room" }), _jsx("th", { children: "Stay" }), _jsx("th", { children: "Status" })] }) }), _jsx("tbody", { children: filtered.map((booking) => (_jsxs("tr", { children: [_jsxs("td", { children: [_jsx("strong", { children: booking.guestName }), _jsx("span", { children: booking.guestEmail })] }), _jsxs("td", { children: [_jsx("strong", { children: booking.roomNumber }), _jsxs("span", { children: [booking.hotelName, " \u00B7 ", booking.roomType] })] }), _jsxs("td", { children: [_jsx("strong", { children: formatDate(booking.checkInDate) }), _jsxs("span", { children: ["to ", formatDate(booking.checkOutDate)] })] }), _jsx("td", { children: _jsx("span", { className: "status status--active", children: "Confirmed" }) })] }, booking.id))) })] }), !filtered.length && (_jsx("p", { className: "manager-empty", children: "No upcoming bookings match these filters." }))] }))] }));
}
